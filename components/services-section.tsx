  ...
  <section className="py-20 px-6 bg-gray-50">
    ...
    <Carousel
      items={services.map((service, index) => (
        <div
          key={index}
          className="bg-[#4579A4] text-white rounded-2xl p-8 shadow-lg flex-shrink-0 flex flex-col items-center text-center min-w-[300px] transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-2xl"
        >
          <div className="w-20 h-20 rounded-full bg-white flex items-center justify-center mb-6 transition-transform duration-300 hover:scale-110">
